...
<inline-notification text="If you are using the SaaS discovery service, the connection URL will be depending on the environment (Dev or Prod) the decision service is deployed on. To find the right connection URL, open your Decision Server console its copy the corresponding highlighted URL from your browser navigation bar(ie: <strong>https://odm-dev-demo-emea-10.automationcloud.ibm.com/</strong>res/protected/home.jsf)."> 
 </inline-notification> 
<br/>
