...
| **Demo downloads** | Operational Decision Manager (Decision Center projects) <br/> • <a href="./Customer_Service.zip" target="_blank" rel="noreferrer">Customer_Service.zip</a> <br/> • <a href="./Get_Request_Details.zip" target="_blank" rel="noreferrer">Get_Request_Details.zip</a> <br/><br/> watsonx Orchestrate (Skills) <br/> • <a href="./XXX_FocusCorp_Customer_Service.json" target="_blank" rel="noreferrer">XXX_FocusCorp_Customer_Service.json</a> <br/> • <a href="./XXX_FocusCorp_Get_data_from_CRM.json" target="_blank" rel="noreferrer">XXX_FocusCorp_Get_data_from_CRM.json</a> <br/><br/> Optional (For ODM experts looking to customize the decision service) <br/> • <a href="./RuleDesignerFiles_V5_20231027.zip" target="_blank" rel="noreferrer">RuleDesignerFiles.zip</a> |
