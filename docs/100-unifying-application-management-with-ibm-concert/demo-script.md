...
| **Action** &nbsp; 3.1.1 | Click the **Latest compliance assessments** switch. <inline-notification text="A green <strong>Latest compliance assessments</strong> section will appear in the diagram."></inline-notification> <br/> <img src="images/3-1-1.png" width="800" /> |
...
| :--- | :--- |
| **Action** &nbsp; 3.2.1 | Click the **Prioritized CVEs** switch. <inline-notification text="A red <strong>Prioritized CVEs</strong> section will appear in the diagram."></inline-notification> <br/> <img src="images/3-2-1.png" width="800" /> |
