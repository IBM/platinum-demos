...
| **Action** &nbsp; 1.7.7 | Enter **Customer Access** (1) as the option name, **Customer** (2) as the alias, **Self-service access to customer event stream** (3) as the description and click **Next** (4).  <br/> <img src="images/1-7-OptionsCreateCustomer.png" width="800" /> |
...
| **Action** &nbsp; 1.7.17 | Enter **Order Access** (1) as the option name, **Order** (2) as the alias, **Self-service access to orders event stream** (3) as the description and click **Next** (4).  <br/> <img src="images/1-7-OptionsCreateOrders.png" width="800" /> |
